...
export default function FileUpload({ onChange, onRemove, value }: ImageUploadProps) {
  ...
  const onUpdateFile = (newFiles: UploadFileResponse[]) => onChange([...value, ...newFiles]);
          ...
          <UploadDropzone<OurFileRouter>
            ...
            content={{
              allowedContent({ isUploading }) {
                if (isUploading) return <p className="mt-2 animate-pulse text-sm text-slate-400">Img Uploading...</p>;
              }
            }}
